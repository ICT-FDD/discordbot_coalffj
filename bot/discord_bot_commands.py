...
from bot.summarizer import get_messages_last_24h, get_messages_last_72h, get_last_n_messages, format_messages_by_day
...
class MessagesCog(commands.Cog):
    ...
    async def preview_by_day_cmd(self, ctx):
        from bot.summarizer import format_messages_by_day  # ex
